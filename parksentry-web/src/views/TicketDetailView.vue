    ...
    <div v-else-if="ticket" style="display:grid;grid-template-columns:2fr 1fr;gap:20px">
      ...
      <div style="display:flex;flex-direction:column;gap:20px">
        <div class="card">
          ...
          <div v-if="ticket.notes" style="margin-top:16px;padding:12px;background:var(--bg-secondary);border-radius:var(--radius-sm)">
        ...
        <div class="card">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
            <div class="info-item"><div class="info-label">Kode</div><div class="info-value" style="color:var(--accent-primary)">{{ ticket.violationType?.code }}</div></div>
            ...
            <div class="info-item"><div class="info-label">Alamat Zona</div><div class="info-value" style="color:var(--text-secondary)">{{ ticket.zone?.address || '—' }}</div></div>
          </div>
        </div>
      </div>
      ...
      <div style="display:flex;flex-direction:column;gap:20px">
        ...
        <div class="card">
          ...
          <div style="display:flex;flex-direction:column;gap:12px">
            ...
            <div class="info-item"><div class="info-label">No. Badge</div><div class="info-value" style="color:var(--accent-primary)">{{ ticket.officer?.badgeNo }}</div></div>
